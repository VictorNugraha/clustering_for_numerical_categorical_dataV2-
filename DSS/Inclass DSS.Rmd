...
$$
Cost Awal: Kelompok 1 + Kelompok 2\\
Cost Awal: (3 + 4 + 4) + (3 + 1 + 1 + 2 + 2)\\
Cost Awal: 20
$$
...
6. [Example of Calcultion Medoids for PAM Algorithm](https://www.geeksforgeeks.org/ml-k-medoids-clustering-with-example/)
